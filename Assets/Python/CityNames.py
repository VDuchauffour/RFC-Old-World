...
name_changes = {
	...
	"Alexandrovka": {
		iPolish: (
			...
			translate("Juzowka", iAfter=iIndustrial),
			"Aleksandrowka",
		),
		iRussian: (
	...
	"Drohiczyn": {
		iPolish: (
			translate("Siedlce", iAfter=iIndustrial),
			_,
		),
	...
	u"Königsberg": {
		...
		iLatin: "Regiomontium",
		iLocal: translate("Twangste", iBefore=iMedieval), # Old Prussian
		iPolish: u"Królewiec",
